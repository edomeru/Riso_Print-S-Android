...
/**
 * PrintSettingsHelper is a helper class that provides methods concerning the print settings of a printer.
 * This class also reads the default settings from the printsettins.xml.
 */
