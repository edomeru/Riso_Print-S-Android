...
- (void)addRealPrinter:(snmp_device*)device
{
    ...
    pd.port = [NSNumber numberWithInt:0]; // Default port when added
    ...
    pd.capFin24Holes = (snmp_device_get_capability_status(device, kSnmpCapabilityFin24Holes)>0 ? YES : NO);
