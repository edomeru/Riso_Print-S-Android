...
- (void)test002_getAspectRatioForPaperSize
{
    ...
    GHAssertLessThanOrEqual(fabs(actualValue - expectedValue),diffThreshold,@"A3WSize aspect ratio");
    //A3
    ...
    GHAssertLessThanOrEqual(fabs(actualValue - expectedValue),diffThreshold,@"FoolscapSize aspect ratio");
    //Tabloid
    ...
    GHAssertLessThanOrEqual(fabs(actualValue - expectedValue),diffThreshold,@"TabloidSize aspect ratio");
    //Legal
    expectedValue = LegalSize.width/LegalSize.height;
    actualValue = [PrintPreviewHelper getAspectRatioForPaperSize:kPaperSizeLegal];
    GHAssertLessThanOrEqual(fabs(actualValue - expectedValue),diffThreshold,@"LegalSize aspect ratio");
    //Letter
    ...
    GHAssertLessThanOrEqual(fabs(actualValue - expectedValue),diffThreshold,@"LetterSize aspect ratio");
    //Statement
    ...
    GHAssertLessThanOrEqual(fabs(actualValue - expectedValue),diffThreshold,@"StatementSize aspect ratio");
}
...
- (void)test003_getPaperDimensions
{
    ...
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"A3WSize width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"A3WSize height");
    //A3
    ...
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"A4Size width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"A4Size height");
    //A5
    expectedValue = A5Size;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeA5 isLandscape:NO];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"A5Size width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"A5Size height");
    //A6
    expectedValue = A6Size;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeA6 isLandscape:NO];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"A6Size width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"A6Size height");
    //B4
    expectedValue = B4Size;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeB4 isLandscape:NO];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"B4Size width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"B4Size height");
    //B5
    expectedValue = B5Size;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeB5 isLandscape:NO];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"B5Size width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"B5Size height");
    //B6
    expectedValue = B6Size;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeB6 isLandscape:NO];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"B6Size width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"B6Size height");
    //Foolscap
    expectedValue = FoolscapSize;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeFoolscap isLandscape:NO];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"FoolscapSize width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"FoolscapSize height");
    //Tabloid
    expectedValue = TabloidSize;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeTabloid isLandscape:NO];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"TabloidSize width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"TabloidSize height");
    //Legal
    expectedValue = LegalSize;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeLegal isLandscape:NO];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"LegalSize width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"LegalSize height");
    //Letter
    expectedValue = LetterSize;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeLetter isLandscape:NO];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"LetterSize width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"LetterSize height");
    //Statement
    expectedValue = StatementSize;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeStatement isLandscape:NO];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.width),diffThreshold,@"StatementSize width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.height),diffThreshold,@"StatementSize height");
    
    //A3W Landscape
    expectedValue = A3WSize;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeA3W isLandscape:YES];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"A3WSize Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"A3WSize Landscape height");
    //A3 Landscape
    expectedValue = A3Size;
    ...
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"A4Size Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"A4Size Landscape height");
    //A5 Landscape
    expectedValue = A5Size;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeA5 isLandscape:YES];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"A5Size Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"A5Size Landscape height");
    //A6 Landscape
    expectedValue = A6Size;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeA6 isLandscape:YES];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"A6Size Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"A6Size Landscape height");
    //B4 Landscape
    expectedValue = B4Size;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeB4 isLandscape:YES];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"B4Size Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"B4Size Landscape height");
    //B5 Landscape
    expectedValue = B5Size;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeB5 isLandscape:YES];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"B5Size Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"B5Size Landscape height");
    //B6 Landscape
    expectedValue = B6Size;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeB6 isLandscape:YES];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"B6Size Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"B6Size Landscape height");
    //Foolscap Landscape
    expectedValue = FoolscapSize;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeFoolscap isLandscape:YES];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"FoolscapSize Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"FoolscapSize Landscape height");
    //Tabloid Landscape
    expectedValue = TabloidSize;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeTabloid isLandscape:YES];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"TabloidSize Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"TabloidSize Landscape height");
    //Legal Landscape
    expectedValue = LegalSize;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeLegal isLandscape:YES];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"LegalSize Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"LegalSize Landscape height");
    //Letter Landscape
    expectedValue = LetterSize;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeLetter isLandscape:YES];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"LetterSize Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"LetterSize Landscape height");
    //Statement Landscape
    expectedValue = StatementSize;
    actualValue = [PrintPreviewHelper getPaperDimensions:kPaperSizeStatement isLandscape:YES];
    GHAssertLessThanOrEqual(fabs(actualValue.width - expectedValue.height),diffThreshold,@"StatementSize Landscape width");
    GHAssertLessThanOrEqual(fabs(actualValue.height - expectedValue.width),diffThreshold,@"StatementSize Landscape height");
}
