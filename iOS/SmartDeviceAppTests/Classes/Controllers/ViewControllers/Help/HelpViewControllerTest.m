...
@interface HelpViewController (UnitTest)
...
@interface HelpViewControllerTest : GHTestCase
{
...
@implementation HelpViewControllerTest
...
- (void)setUpClass
{
    ...
    NSString* controllerName = @"HelpViewController";
...
- (void)test001_IBOutletsBinding
{
    ...
    GHAssertNotNil([controller webView], @"");
