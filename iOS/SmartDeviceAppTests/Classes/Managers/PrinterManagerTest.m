...
- (void)test003_GetPrinters
{
    ...
    for (NSUInteger i = 0; i < NUM_PRINTERS; i++)
    {
        ...
        GHAssertTrue([testPrinter.enabled_raw boolValue], @"setting is different than expected");
        ...
        GHAssertTrue([testPrinter.enabled_finisher_2_4_holes boolValue], @"setting is different than expected");
        GHAssertTrue([testPrinter.enabled_tray_auto_stacking boolValue], @"setting is different than expected");
        GHAssertTrue([testPrinter.enabled_tray_face_down boolValue], @"setting is different than expected");
        GHAssertTrue([testPrinter.enabled_tray_stacking boolValue], @"setting is different than expected");
        GHAssertTrue([testPrinter.enabled_tray_top boolValue], @"setting is different than expected");
