...
namespace DirectPrint
{
    ...
    public:
		...
		static String^ create_pjl_fw_wrapper(String^ settings, String^ appName, String ^appVersion);
		static String^ create_pjl_gd_wrapper(String^ settings, String^ appName, String ^appVersion);
    };
}