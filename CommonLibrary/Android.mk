...
LOCAL_SRC_FILES := src/directprint.c src/snmp.c src/printsettings.c src/util.c src/printsettings_fw.c src/printsettings_gd.c src/printsettings_ft.c src/printsettings_gl.c
