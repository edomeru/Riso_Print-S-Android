...
public final class KeyConstants {
    ...
    public static final String KEY_SQL_PRINTER_EN_LPR = "prn_enabled_lpr";
    public static final String KEY_SQL_PRINTER_EN_RAW = "prn_enabled_raw";
    public static final String KEY_SQL_PRINTER_EN_PAGINATION = "prn_enabled_pagination";
